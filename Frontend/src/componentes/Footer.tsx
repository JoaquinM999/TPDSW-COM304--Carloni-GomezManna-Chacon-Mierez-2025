...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <>
      ...
      <footer className="bg-gray-900 text-white select-none overflow-hidden relative z-10">
        {showNewsletter && (
          <motion.div
          ...
          >
            ...
            />
            <div className="relative max-w-5xl mx-auto px-6 sm:px-12 text-center text-gray-900">
              ...
              <p className="max-w-xl mx-auto mb-10 select-text text-gray-700">
              ...
              <form className="flex flex-col sm:flex-row justify-center gap-4 max-w-md mx-auto">
                <motion.input
                  ...
                  className="flex-grow rounded-lg px-5 py-3 text-gray-900 placeholder-gray-500 bg-white/90 backdrop-blur-md focus:outline-none focus:ring-4 focus:ring-indigo-400 focus:ring-opacity-70 transition shadow-md"
        ...
        <div className="py-14 max-w-7xl mx-auto px-6 sm:px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          >
            ...
            <p className="text-gray-400 max-w-md leading-relaxed select-text">
              ...
              <div className="flex space-x-6 mt-6">
                {socialMedia.map(({ icon: Icon, href, label, color }, i) => (
                  <motion.a
                    ...
                    className="p-3 rounded-lg bg-gray-800 hover:bg-gray-700 shadow-lg transition flex items-center justify-center"
                  >
          ...
          {linksToShow.map(({ title, links }, idx) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-lg font-semibold mb-6 text-gray-300 select-text">{title}</h3>
              <ul className="space-y-4">
                {links.map(({ name, href }, i) => (
                  ...
                  >
                    <a
                      href={href}
                      className="flex items-center gap-1 text-gray-400 hover:text-blue-400 transition-colors duration-200 no-underline"
                    >
                      {name}
                      <motion.span
        ...
        <div className="border-t border-gray-800 py-6">
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm select-text">
