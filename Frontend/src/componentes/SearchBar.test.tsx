...
describe('SearchBar', () => {
  ...
  it.skip('debe llamar a onSearch cuando se provee (TODO: verificar implementación de debounce)', async () => {
    const user = userEvent.setup();
    ...
    // TODO: Verificar si el componente llama a onSearch después del debounce
    await waitFor(() => {
