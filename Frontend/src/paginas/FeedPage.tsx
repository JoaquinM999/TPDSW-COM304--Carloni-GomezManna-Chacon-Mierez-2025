    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Error al cargar feed</h2>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Feed de Actividades</h1>
          <p className="text-gray-600">Descubre qué hacen las personas que sigues</p>
        </div>

        <div className="space-y-6">
          {actividades.map((actividad) => (
            <div key={actividad.id} className="bg-white rounded-xl shadow-lg p-6">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 mb-4">{getActividadText(actividad)}</p>
                  ...
                  {actividad.resena && (
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h4 className="font-medium text-gray-900 mb-2">{actividad.resena.titulo}</h4>
                      <p className="text-gray-700 text-sm line-clamp-3">{actividad.resena.comentario}</p>
                    </div>
                  )}
                </div>
              </div>
          ...
          {actividades.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">No hay actividades aún</h3>
