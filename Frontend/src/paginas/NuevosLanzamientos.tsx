    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg">Cargando nuevos lanzamientos...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-4xl font-bold text-gray-900">Nuevos Lanzamientos</h1>
          </div>
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <span className="text-purple-600 font-medium">{libros.length} libros nuevos</span>
          </div>
        </div>
        ...
        {libros.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 text-xl">No hay nuevos lanzamientos en este momento</p>
            <p className="text-gray-500 mt-2">Vuelve pronto para ver las novedades</p>
          </div>
        ) : (
