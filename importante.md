...
3. Mostrar recomendaciones personalizadas cn ia ((((hacer funcionar ahora usa un algoritmo nomas))))
...
ya q los corazones andan en la bdd

---

# 🟢 PRIORIDAD BAJA (UI/UX)

revisar lo del modo oscuro pq hay algunas secciones que no se ven tan bien